...
-- ---------------------------------------------------------------- grants
GRANT SELECT ON public.poker_tables TO anon, authenticated;
GRANT ALL ON public.poker_tables TO service_role;
GRANT ALL ON public.poker_table_secrets TO service_role;
GRANT SELECT ON public.poker_players TO anon, authenticated;
GRANT UPDATE ON public.poker_players TO authenticated;
